      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="min-w-[220px] flex-1">
          ...
          <div className="mt-2 flex flex-wrap gap-1.5">
            {employee.skills.slice(0, 5).map((skill) => (
              <span
                key={skill}
                className="rounded-full border border-[hsl(var(--border))] px-2.5 py-1 text-xs text-[hsl(var(--muted-foreground))]"
              >
                {skill}
              </span>
            ))}
        ...
        <div className="text-sm text-[hsl(var(--muted-foreground))]">
          ...
          <p className="mt-1 flex items-center gap-2">
            <span
              className={`h-2.5 w-2.5 rounded-full ${availDot(employee.availability)}`}
            />
        ...
        <span
          className={`rounded-full px-3 py-1 text-sm font-semibold ${matchClass(employee.match)}`}
        >
          {employee.match}%
        </span>
        ...
        <div className="flex gap-2">
          ...
          <button
            className="rounded-lg bg-[hsl(var(--primary))] px-3 py-2 text-xs font-medium text-white transition hover:brightness-110"
